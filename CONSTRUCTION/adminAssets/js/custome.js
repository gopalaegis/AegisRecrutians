...
$(".back-btn").click(function () {
    $(".col1").css('width', '55px');
    $(".col2").css('width', 'calc(100vw - 55px)');
    $(".left-side").css('width', '55px');
    $(".back-btn").hide();
    $(".back-btn1").show();
...
$(".back-btn1").click(function () {
    $(".col1").css('width', '220px');
    $(".col2").css('width', 'calc(100vw - 220px)');
    $(".left-side").css('width', '220px');
    $(".back-btn1").hide();
    $(".back-btn").show();
    $('.accordion1').removeClass('hidden');
    $('.panel1').show();

});


$(".accordion1, .dashboard-head").click(function () {
    $(".col1").css('width', 'auto');
    $(".left-side").css('width', 'auto');
    $(".back-btn1").hide();
    $(".back-btn").show();
    $('.accordion1').removeClass('hidden');
    $('.panel1').show();
...
$(".accordion1").click(function () {
    ...
    $(this).addClass('current .fa').siblings().removeClass('current .fa');
});



$(document).ready(function () {
    $(".nav-prof-btn").focusin(function () {
        $(this).css({ "background-color": "#fff", "color": "#5C2F91", "box-shadow": "0 0 10px 0 rgba(0,0,0,0.1)" });
    });
    $(".nav-prof-btn").focusout(function () {
        $(this).css({ "background-color": "#5C2F91", "color": "#fff", "border": "2px solid #fff!important" });
    });
});
        ...
        (j.prototype.update = function (a, b) {
            (a = a || !1),
                ...
                ((this.min = h(this.$element[0].getAttribute("min"), 0)),
                    (this.max = h(this.$element[0].getAttribute("max"), 30)),
                    (this.value = h(
